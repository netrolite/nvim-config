...
-- opt.wrap = false -- prevent long lines from wrapping
-- (use :set wrap to set this to true. Can be useful in markdown)
...
-- allow using vim motions in Russian keyboard layout
vim.opt.langmap =
